...
$sql = "SELECT id, name, price, image, product_id FROM bottomwear";
...
<head>
    ...
    <title>Closetly - Bottomwear Collection</title>
...
<body>
    ...
    <div class="catalog-container">
        <h2 class="section-title">Bottomwear Collection</h2>
        <div class="row g-4">
            <?php foreach ($bottomwear as $btmw): ?>
                <div class="col-md-3">
                    <div class="product-card">
                        <img src="<?php echo htmlspecialchars($btmw['image']); ?>" alt="<?php echo htmlspecialchars($btmw['name']); ?>">
                        <div class="product-info">
                            <h5 class="product-name"><?php echo htmlspecialchars($btmw['name']); ?></h5>
                            <p class="product-price">₹<?php echo htmlspecialchars($btmw['price']); ?></p>
                            <form method="post" action="cart_system.php">
                                <input type="hidden" name="product_id" value="<?= htmlspecialchars($btmw['product_id']); ?>">
                                <input type="hidden" name="name" value="<?= htmlspecialchars($btmw['name']); ?>">
                                <input type="hidden" name="price" value="<?= htmlspecialchars($btmw['price']); ?>">
                                <input type="hidden" name="image" value="<?= htmlspecialchars($btmw['image']); ?>">
