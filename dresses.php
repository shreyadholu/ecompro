...
$sql = "SELECT id, name, price, image,product_id FROM dresses";
...
<head>
    ...
    <title>Closetly - Dresses Collection</title>
...
<body>
    ...
    <div class="container catalog-container">
        <h2 class="section-title">Dresses Collection</h2>
        <div class="row g-4">
            <?php foreach ($dresses as $dress): ?>
                <div class="col-md-3">
                    <div class="product-card">
                        <img src="<?php echo htmlspecialchars($dress['image']); ?>" alt="<?php echo htmlspecialchars($dress['name']); ?>">
                        <div class="product-info">
                            <h5 class="product-name"><?php echo htmlspecialchars($dress['name']); ?></h5>
                            <p class="product-price">₹<?php echo htmlspecialchars($dress['price']); ?></p>
                            <form method="post" action="cart_system.php">
                                <input type="hidden" name="product_id" value="<?= htmlspecialchars($dress['product_id']); ?>">
                                <input type="hidden" name="name" value="<?= htmlspecialchars($dress['name']); ?>">
                                <input type="hidden" name="price" value="<?= htmlspecialchars($dress['price']); ?>">
                                <input type="hidden" name="image" value="<?= htmlspecialchars($dress['image']); ?>">
