...
$sql = "SELECT id, name, price, image, product_id FROM footwear";
...
<head>
    ...
    <title>Closetly - Footwear Collection</title>
...
<body>
    ...
    <div class="catalog-container">
        ...
        <div class="row g-4">
            <?php foreach ($footwear as $ftw): ?>
                <div class="col-md-3">
                    <div class="product-card">
                        <img src="<?php echo $ftw['image']; ?>" alt="<?php echo $ftw['name']; ?>">
                        <div class="product-info">
                            <h5 class="product-name"><?php echo $ftw['name']; ?></h5>
                            <p class="product-price">₹<?php echo $ftw['price']; ?></p>
                            <form method="post" action="cart_system.php">
                                <input type="hidden" name="product_id" value="<?= $ftw['product_id']; ?>">
                                <input type="hidden" name="name" value="<?= $ftw['name']; ?>">
                                <input type="hidden" name="price" value="<?= $ftw['price']; ?>">
                                <input type="hidden" name="image" value="<?= $ftw['image']; ?>">
