...
<head>
    ...
    <title>Closetly - Tops Collection</title>
...
<body>
    ...
    <div class="catalog-container">
        <h2 class="section-title">Tops Collection</h2>
        <div class="row g-4">
            <?php foreach ($topss as $tops): ?>
                <div class="col-md-3">
                    <div class="product-card">
                        <img src="<?php echo htmlspecialchars($tops['image']); ?>" alt="<?php echo htmlspecialchars($tops['name']); ?>">
                        <div class="product-info">
                            <h5 class="product-name"><?php echo htmlspecialchars($tops['name']); ?></h5>
                            <p class="product-price">₹<?php echo htmlspecialchars($tops['price']); ?></p>
                            <form method="post" action="cart_system.php">
                                <input type="hidden" name="product_id" value="<?= htmlspecialchars($tops['product_id']); ?>">
                                <input type="hidden" name="name" value="<?= htmlspecialchars($tops['name']); ?>">
                                <input type="hidden" name="price" value="<?= htmlspecialchars($tops['price']); ?>">
                                <input type="hidden" name="image" value="<?= htmlspecialchars($tops['image']); ?>">
